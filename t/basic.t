...
@foo = VMS::SysInfo::sys_info_names;
if (scalar(@foo) > 0) {
  print "ok 2\n";
} else {
  print "not ok 2\n";
...
$NodeName = VMS::SysInfo::get_one_sys_info_item("NODENAME");
...
tie %testhash, VMS::SysInfo, $$ or print "not ";
print "ok 4\n";
...
if (!defined($foo = VMS::SysInfo::get_all_sys_info_items($$))) {
  print "not ";
};
print "ok 6\n";
